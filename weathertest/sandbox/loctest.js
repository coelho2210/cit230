...
//https://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=P51AQbUriOlYdji9xUai8n1GEAV1enQN&q=43.816667%2C-111.783333
...
function getCode(LOCALE) {
    const API_KEY = 'P51AQbUriOlYdji9xUai8n1GEAV1enQN';
...
function getWeather(locData) {
    ...
    const URL = "http://dataservice.accuweather.com/currentconditions/v1/332634?apikey=P51AQbUriOlYdji9xUai8n1GEAV1enQN&details=true" + CITY_CODE + "?apikey=" + API_KEY + "&details=true";
    fetch(URL)
        .then(response => response.json())
        .then(function (data) {
